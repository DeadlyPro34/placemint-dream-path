    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden gradient-hero">
      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Main Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 slide-up px-4">
          ...
          {/* Subtitle */}
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-6 sm:mb-8 slide-up stagger-1 px-4">
            Connect with top companies and unlock amazing internship and job opportunities
          </p>

          {/* Search Bar */}
          <div className="max-w-2xl mx-auto mb-8 sm:mb-12 slide-up stagger-2 px-4">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16 slide-up stagger-3 px-4">
            <Button 
              size="lg" 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 px-4">
            {stats.map((stat, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full gradient-primary mb-3 sm:mb-4 shadow-glow">
